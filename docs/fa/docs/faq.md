...
??? question "چرا بعضی سایت‌ها یا برنامه‌ها مثل توییتر و ChatGPT رو درست باز نمیکنه!"
    تعداد Proxy IP ها زیاده و ممکنه تعداد زیادیشون پایدار نباشن. باید از صفحه مربوطه تست کنید تا یه خوبشو پیدا کنید.
...
??? question "چرا وقتی میرم به آدرس `panel/` ارور میده؟"
    پنل فقط با استفاده از Wizard قابل نصبه. به محض ساخت پنل آدرسش رو ذخیره کنید چون از /panel قابل دسترسی نیست.
...
??? question "دپلوی کردم ولی ارور 1101 میده کلادفلر!"
    ...
    [روش ساخت خودکار](wizard.md) ارائه شده که از همه‌ی روش‌ها بیشتر توصیه میشه. در حال حاضر از این روش اقدام کنید.
...
??? question "چرا ویندوز ZAGROOO Wizard رو ویروس تشخیص میده؟"
...
??? question "چرا وقتی میخوام ساب sing-box رو وارد کنم ارور میده"
    کانفیگ‌های ZAGROOO فقط از sing-box نسخه 1.12.0 و بالاتر پشتیبانی میکنن.
