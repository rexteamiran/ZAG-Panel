...
![پنل زاگرو](images/panel-overview.jpg)

## معرفی پروژه

این پروژه یه پنل کاربری برای ساخت و مدیریت کانفیگ‌های **رایگان**، **امن** و **خصوصی** **VLESS**، **Trojan** و **Warp** هست که در کنارش یک سرور **DoH** با قابلیت شصی‌سازی ارائه می‌ده که حتی وقتی دامنه‌ها یا سرویس Warp توسط اپراتورها فیلتر شدن، اتصال رو تضمین می‌کنه. این پنل به دو روش **Wrokers** و **Pages** و از طریق [ZAGROOO Wizard](https://github.com/rexteamiran/ZAG-Wizard) راه‌اندازی می‌شه.

🌟 اگه **پنل زاگرو** براتون مفید بوده، با حمایتتون بهم دلگرمی می‌دید 🌟
...
- **تبدیل شدن به گره**: قابلیت به اشتراک‌گذاری تنظیمات پنل با دیگر کاربران ZAGROOO.
- **تجمیع پروکسی**: قابلیت تجمیع پروکسی‌های شخصی با کانفیگ‌های ZAGROOO و تحویل در یک لینک اشتراک.
