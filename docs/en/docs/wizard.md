# :material-new-box:{ .md .middle } ZAGROOO Wizard

To simplify the setup process and prevent user mistakes during installation, the [ZAGROOO Wizard](https://github.com/rexteamiran/ZAG-Wizard) project was launched which provides online and CLI installations. It supports both Workers and Pages methods and just takes a few seconds to install panel!

<p align="center" class="img-wrapper">
  <img src="/ZAG-Panel/images/wizard-web.jpg" width="400" alt="wizard-web" />
  <img src="/ZAG-Panel/images/wizard-cli.jpg" width="400" alt="wizard-cli" />
</p>
...
To easily install the latest stable version of ZAGROOO Panel online:
...
irm https://raw.githubusercontent.com/rexteamiran/ZAG-Wizard/main/install.ps1 | iex
```

```bash title="Android (Termux) - Linux - macOS"
bash <(curl -fsSL https://raw.githubusercontent.com/rexteamiran/ZAG-Wizard/main/install.sh)
```
