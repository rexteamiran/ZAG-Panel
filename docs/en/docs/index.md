...
This project is aimed to provide a user panel to access FREE, SECURE, PRIVATE proxies and tools including **VLESS**, **Trojan** and **Warp** configs alongside a **private DoH** server for cross-platform clients. It ensures connectivity even when domains or Warp services are blocked by ISPs, offering **Workers** and **Pages** deployments using [ZAGROOO Wizard](https://github.com/rexteamiran/ZAG-Wizard) in a few seconds!

🌟 If you found **ZAGROOO Panel** valuable, Your donations make all the difference 🌟
...
12. **Node ability:** Can share settings and proxies across other ZAGROOO users.
13. **Proxy aggregation:** Supports aggregating another proxies into ZAGROOO proxies and deliver in a single subscription
